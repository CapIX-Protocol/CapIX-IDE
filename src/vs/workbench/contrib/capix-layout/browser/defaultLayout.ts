...
import { IViewContainersRegistry, IViewDescriptorService, Extensions, ViewContainerLocation } from '../../../common/views.js';
...
export class CapixDefaultLayoutContribution extends Disposable implements IWorkbenchContribution {
	...
	private applyOnce(): void {
		...
		try {
			...
			const listener = Registry.as<IViewContainersRegistry>(Extensions.ViewContainersRegistry).onDidRegister(e => {
				try {
